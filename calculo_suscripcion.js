...
let descuentoProfesional = 75;
let descuentoSidicalizados = 50;
let descuentoAsociados= 10;
...
function total_a_pagar() {
    ...
    if (categoria.value == 1) {
        totalValorTickets = totalValorTickets - (descuentoProfesional / 100 * totalValorTickets);
    }
    if (categoria.value == 2) {
        totalValorTickets = totalValorTickets - (descuentoSidicalizados / 100 * totalValorTickets);
    }
    if (categoria.value == 3) {
        totalValorTickets = totalValorTickets - (descuentoAsociados / 100 * totalValorTickets);
    }*/
    function MultiplicoCantidadDeTicket (totalValorTickets) {
